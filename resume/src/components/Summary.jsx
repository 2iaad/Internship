...
export default function Summary() {
  ...
  const defaultSummary = "Full-Stack Engineer and 1337 Coding School graduate. Experienced in building full-stack web applications and systems-level projects. Known for strong debugging skills, clean code, and building maintainable architectures."
